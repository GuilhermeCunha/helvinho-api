...
export class fixDatetimeParameter1595273598193 implements MigrationInterface {
    name = 'fixDatetimeParameter1595273598193'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `parameter` ADD `date` datetime NOT NULL");
